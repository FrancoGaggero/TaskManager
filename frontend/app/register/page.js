      ...
      <div className="mt-20 w-full max-w-md">
        <div className="bg-[#2D2D2D] rounded-3xl shadow-2xl border border-[#FFB347]/30 p-10">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-white mb-4">Crear Cuenta</h2>
            <p className="text-gray-300">Registrate para empezar a organizar tus tareas</p>
          </div>
          ...
          {success && (
            <div className="mt-4 p-4 bg-green-500/20 border border-green-500/50 text-green-400 rounded-xl text-center">
          ...
          <p className="mt-6 text-center text-gray-300">
            ¿Ya tenés cuenta?{" "}
            <a href="/" className="text-[#FFB347] hover:text-[#FF8C00] font-semibold hover:underline transition-colors">
              Iniciá sesión
            </a>
          </p>
        </div>
